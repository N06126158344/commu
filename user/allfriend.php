    ...
    <div class="row flex-nowrap">
        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
            ...
            <?php
                ...
                <h4 class="section-title">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;เพื่อน <?php echo $rowcount?> คน</h4>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="card-body card-one">
                                <div class="header">
                                    <div class="avatar" >
                                        <a href="profilefriends.php?USERID=<?php echo $result['USERID']; ?>" class="nav-link text-black">
