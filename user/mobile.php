...
<?php 
    include('connection.php');
    $sql = "SELECT * FROM pouser INNER JOIN users ON pouser.USERID = users.USERID WHERE typeser = 'Mobile'";
    $query = mysqli_query($conn, $sql);
        ...
        <div class="card-header">
          ...
          <div class="row gx-3 mb-3">
            ...
            <div class="row justify-content-center align-items-center">
                ...
                <hr class="my-3"><br>
                  <form action='commentsmobile.php?POID=<?php echo $result['POID']; ?>' method="POST" enctype="multipart/form-data">
