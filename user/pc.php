        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="typeser" value="PC">
                        <label class="form-check-label" for="typeser"><h5>PC</h5></label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="typeser" value="Mobile">
                        <label class="form-check-label" for="typeser"><h5>Mobile</h5></label>
                    </div>
                    <br><br>
                    <h6># โปรดใส่รูปภาพประกอบ</h6>
...
<?php 
    include('connection.php');
    $sql = "SELECT * FROM pouser INNER JOIN users ON pouser.USERID = users.USERID WHERE typeser = 'PC'";
    $query = mysqli_query($conn, $sql);
        ...
        <div class="card-header">
          ...
          <div class="row gx-3 mb-3">
            ...
            <div class="row justify-content-center align-items-center">
                ...
                <hr class="my-3"><br>
                  <form action='commentspc.php?POID=<?php echo $result['POID']; ?>' method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                          ...
                          <input type="text" name="comser" class="form-control" placeholder = "ความคิดเห็น..." />
                        </div>
                        <div class="col-2">
...
<?php
    include('connection.php');
    $sql2 = "SELECT *  FROM commentsser LEFT JOIN users on commentsser.USERID = users.USERID where POID = '$POID'";
